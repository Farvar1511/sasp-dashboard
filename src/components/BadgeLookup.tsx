...
export default function BadgeLookup() {
  ...
  const [selectedTrooper, setSelectedTrooper] = useState<RosterData | null>(null);
      ...
      <div className="page-content" style={{ display: 'flex', justifyContent: 'center', paddingTop: '2rem' }}>
        <div style={{ background: '#222', padding: '2rem', borderRadius: '8px', width: '100%', maxWidth: '900px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', margin: '1rem 0' }}>
            <label style={{ color: '#fff', marginRight: 10 }}>Badge Number:</label>
            <input
              type="text"
              value={badgeInput}
            ...
            />
            <button className="button-primary" style={{ marginLeft: 10 }} onClick={handleLookup}>
              Lookup
            </button>
          </div>
          ...
          {selectedTrooper && (
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '1rem' }}>
              ...
              <div>
                ...
                <div className="info-box">Callsign: {selectedTrooper.Callsign}</div>
              </div>
              ...
              <div>
                ...
                <div className="info-box">
                  {selectedTrooper.SWAT ? selectedTrooper.SWAT : 'No SWAT info available'}
                </div>
              </div>

              {/* Authorized Communal Vehicles */}
              <div>
                <h3 style={{ color: 'orange' }}>Authorized Communal Vehicles</h3>
                <div className="info-box">
